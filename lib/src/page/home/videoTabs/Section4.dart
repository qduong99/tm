    ...
    return Container(
      ...
      child: Padding(
        ...
        child: GridView.count(
          ...
          shrinkWrap: true,
          children: <Widget>[
            ItemIcon(text: Text(video1), iconData: Icons.video_collection_sharp, onTap:() {_onGIPlanned(5);}),
            ItemIcon(text: Text(video2), iconData: Icons.video_collection_sharp, onTap: (){
              _onGIPlanned(6);
            }),
          ],
        ),
